...
export const BIOME_SPAWN_RATES = {
    ...
    "Bio": {
        "StemCell": { weight: 0.01, minLevel: 1, maxLevel: 5 },
        ...
        "Cancer":{ weight: 0.03, minLevel: 1, maxLevel: 5 }
    },
    ...
    "Random": {
        ...
        "Square": { weight: 0.000000001, minLevel: 2, maxLevel: 5},
    },
    ...
    "Ocean": {
        ...
        "CrabHole": { weight: 1, minLevel: 2, maxLevel: 5 }       // 蟹洞 - 稀有，会生成螃蟹
    },
    // ========== 🆕 下水道生物生成概率 ==========
    "Sewer": {
        // 基础生物
        ...
        "ManHole": { weight: 0.5, minLevel: 2, maxLevel: 5 },
    ...
    "Bio": [
        {
            ...
            spawnRules: [
                ["StemCell", 0.04, 3, 5, ["Super", "Omega"]],
                ["Cancer", 0.06, 2, 5, ["Super", "Omega"]],
